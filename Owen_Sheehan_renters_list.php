...
$query = 'SELECT fname, sname, tel FROM customers WHERE id = ANY(SELECT cust FROM rentals WHERE return_date IS NULL)ORDER by tel;';
...
if (! ($result)) {
    ...
    echo "<table><caption>Customers with videos on loan</caption>";
